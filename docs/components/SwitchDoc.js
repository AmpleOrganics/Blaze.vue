...
/>`,
  apiRows: [
    ...
    { name: 'switchValue', type: '[String, Number, Boolean, Object], required', default: 'true', description: 'Defines the value associated with the input.' },
    { name: 'showLabel', type: 'Boolean', default: 'true', description: 'Hide or unhide the text label.' },
    { name: 'switchLabel', type: 'String, required', default: '-', description: 'Text label next to the switch.' },
