...
/>`,
  apiRows: [
    ...
    { name: 'label', type: 'String', default: 'null', description: 'Defines the text label above the text area.' },
    ...
    { name: 'maxLength', type: 'Number', default: '', description: 'Defines the max length of characters within the text area.' },
    { name: 'minLength', type: 'Number', default: '', description: 'Defines the minimum length of characters within the text area.' },
    { name: 'rows', type: 'Number', default: '', description: 'Defines the number of rows of the text area.' },
